...
<h1 class = "display-3">Form for update users data</h1>
    <div class = "container mt-5">
        ...
        <br>
        @endif
        <form action="{{url('update')}}" method = 'post' accept-charset='utf-8'>
            @csrf
            
            <input type="hidden" name="id" value="{{$data['id']}}">
            <div class ="form-group">
                <label class = "control-label" for="firstname">First Name</label>
                <input type = "text" name = "firstname" class = "form-control" id="first_name" value="{{$data['firstname']}}">
                <span id="err1" class="text-danger">@error('firstname'){{$message}}@enderror</span> 
            </div>

            <div class ="form-group">
                <label class = "control-label" for="lastname">Last Name</label>
                <input type = "text" name = "lastname" class = "form-control" id="lats_name" value="{{$data['lastname']}}">
            ...
            <div class="mb-3">
                ...
                <input type="file" name="pro_img"  class="form-control" id="photo"/>
